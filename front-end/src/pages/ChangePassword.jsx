...
function ChangePassword() {
    ...
    const handleConfirmChanges = async (event) => {
        ...
        try {
            ...
            if (res.status === 401) {
                ...
                if (
                    body.message &&
                    body.message.toLowerCase().includes("current password")
                ) {
            ...
            if (!res.ok || body.success === false) {
                throw new Error(
                    body.error || body.message || "Password change failed"
                );
            }
    ...
    return (
        <div className="min-h-[90vh] bg-[#efefed] text-[#282f32] px-6 py-4 flex flex-col">
            ...
            <main className="mx-auto w-full max-w-md md:max-w-xl flex-grow flex flex-col justify-between">
                <h1 className="text-4xl font-semibold mb-2">Change Password</h1>
